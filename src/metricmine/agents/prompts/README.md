...
for the silver `describe` stance, `silver_amend.md` for the silver
`amend` stance; later stances add their own file). The harness refuses to run without the prompt file for
